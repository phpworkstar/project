          ...
          <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Список заказов <?php echo $page;?> </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                      <tr><th>Имя клиента</th><th>Товары</th><th>адрес электронной почты</th><th>адрес</th><th>Подробности</th><th>Доставка</th><th>Время заказа</th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <td>
                        <a class=' mb mb-danger' href='orders.php?order_id=$order_id&action=delete'>Delete</a>
                        </td></tr>";
                        }
                        ?>
                    </tbody>
