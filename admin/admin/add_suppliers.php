          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Профиль</p>
                </div>
                <div class="card-body">
                  <form action="" method="post" name="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Адрес электронной почты</label>
                    ...
                    <button type="submit" name="mb_save" id="mb_save" class="mb mb-primary pull-right">Добавить</button>
